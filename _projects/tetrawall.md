...
As a previous game jam was a success, I decided to try it once again. This time I picked the OneLoneCoder's game jam as I am a subscriber of his YouTube channel. By that time I noticed the existence of virtual consoles. So I decided to use [TIC-80](https://tic.computer/) for this challenge.

[comment]: <> (TODO: Interesting features)
...
- Gamejam
	...
	- https://youtu.be/X1OLETFrwFI?t=1380

{% include youtube.html id='X1OLETFrwFI?start=1380' %}
