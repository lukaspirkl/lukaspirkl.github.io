...
<div class="row">
	...
	<div class="6u$ 12u$(small)">
		...
		<ul class="icons">
			...
			<li><a href="#" class="icon fab fa-tumblr"><span class="label">Tumblr</span></a></li>
		</ul>
		<ul class="icons">
			<li><a href="#" class="icon alt fab fa-twitter"><span class="label">Twitter</span></a></li>
			<li><a href="#" class="icon alt fab fa-facebook"><span class="label">Facebook</span></a></li>
			<li><a href="#" class="icon alt fab fa-instagram"><span class="label">Instagram</span></a></li>
		</ul>
...
<ul class="actions">
	<li><a href="#" class="button special icon fas fa-search">Icon</a></li>
